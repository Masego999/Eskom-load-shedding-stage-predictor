# Eskom-load-shedding-stage-predictor
This project uses a simplified **linear regression model** to estimate the load shedding stage based on key power system variables.
...
β = (XᵀX)⁻¹ Xᵀy
This is a core BSc Mathematics / Linear Algebra topic and directly maps to real Eskom operational data published in their System Status reports.
...
bashgit clone https://github.com/your-username/eskom-dashboard.git
cd eskom-dashboard
open index.html
...
Your dashboard will be live at https://your-username.github.io/eskom-dashboard


Extending the project
FeatureHowReal-time stage dataIntegrate EskomSePush API (free tier)Train real weightsCollect Eskom System Status CSV data, solve Normal Equation in Python/NumPyArea-based scheduleMap suburb → Eskom area code → ERF schedule from APIPush notificationsService Worker + Web Push APIHistorical chartChart.js with fetched historical stage data
...
About
Built by Kotlhai Masego project. Demonstrates applied mathematics (linear regression), clean software architecture (separation of concerns), and real-world problem relevance (South African energy infrastructure).
